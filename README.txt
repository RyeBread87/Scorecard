...
You will also need to have Excel installed as well as the OLEDB driver provided in the the Microsoft Access Database Engine (which can be installed here: https://www.microsoft.com/en-gb/download/details.aspx?id=13255).
