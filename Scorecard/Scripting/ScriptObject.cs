...
namespace Cb.Web.Scripting {
	...
	/// <summary>
	/// Represents a single scriptable object
	/// </summary>
    public interface ScriptObject : IReflect {		
		...
		void SetExpando(object key, object value);

		/// <summary>
		/// Removes the expando value for the specified key
		/// </summary>
		/// <param name="key">key</param>
		void DeleteExpando(object key);
		...
		/// <returns></returns>
		MemberInfo[] GetDomMember(ScriptDomLevel level, string name);
